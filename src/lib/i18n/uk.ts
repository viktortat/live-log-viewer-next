...
export const uk = {
  ...
  "dash.branchesLive": { one: "{count} гілка працює", few: "{count} гілки працюють", many: "{count} гілок працюють" },
  "dash.trees": { one: "{count} дерево", few: "{count} дерева", many: "{count} дерев" },
  "dash.recentConvos": { one: "{count} нещодавня розмова", few: "{count} нещодавні розмови", many: "{count} нещодавніх розмов" },
  "dash.quietTrees": { one: "{count} тихе дерево", few: "{count} тихі дерева", many: "{count} тихих дерев" },
  ...
  "composer.imagesCount": { one: "{count} картинка", few: "{count} картинки", many: "{count} картинок" },
  ...
  "link.woke": "агент прокинувся у tmux {target}",
  "link.sentTo": "надіслано у tmux {target}",
  "link.title": "звʼязати агентів",
  "link.close": "Закрити картку звʼязування",
  "link.to": "кому",
  "link.context": "контекст",
  "link.explain": "Агент отримає шлях до цього транскрипта з пропозицією прочитати розмову. Додай, що саме в нього попросити:",
  "link.placeholder": "що зробити з цим контекстом…",
  "link.askAria": "Прохання для звʼязаного агента",
  "link.linking": "звʼязую…",
  "link.link": "▶ Звʼязати",
  "link.resuming": "якщо агент не запущений — резюмую його вікно (до хвилини)…",
  ...
  "img.imageWord": { one: "картинка", few: "картинки", many: "картинок" },
  ...
  "question.replyBelow": "Можна відповісти через композер нижче.",
  ...
  "feed.onlyService": "Видимих повідомлень нема — лише службові записи ({count}). Натисни «Службові»",
  ...
  "render.commands": { one: "{count} команда", few: "{count} команди", many: "{count} команд" },
  ...
  "roundDeck.findings": { one: "{count} знахідка", few: "{count} знахідки", many: "{count} знахідок" },
  ...
  "overview.projects": { one: "{count} проєкті", few: "{count} проєктах", many: "{count} проєктах" },
